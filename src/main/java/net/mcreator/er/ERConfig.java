...
public class ERConfig {
	...
	public static final ForgeConfigSpec.ConfigValue<Double> EPIC_DMG_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> LEGENDARY_DMG_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> MYTHIC_DMG_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> COMMON_HP_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> UNCOMMON_HP_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> RARE_HP_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> EPIC_HP_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> LEGENDARY_HP_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> MYTHIC_HP_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> COMMON_OTHER_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> UNCOMMON_OTHER_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> RARE_OTHER_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> EPIC_OTHER_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> LEGENDARY_OTHER_SCALING;
	public static final ForgeConfigSpec.ConfigValue<Double> MYTHIC_OTHER_SCALING;
	public static final ForgeConfigSpec.ConfigValue<List<? extends String>> FLOWER_OF_LIFE_MAIN_ATTR;
	public static final ForgeConfigSpec.ConfigValue<List<? extends String>> PLUME_OF_DEATH_ATTR;
	public static final ForgeConfigSpec.ConfigValue<List<? extends String>> SANDS_OF_EON_ATTR;
	public static final ForgeConfigSpec.ConfigValue<List<? extends String>> GOBLET_OF_EONOTHEM_ATTR;
	public static final ForgeConfigSpec.ConfigValue<List<? extends String>> CIRCLET_OF_LOGOS_ATTR;
	public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MINOR_ATTR;

	private static final List<String> flower_of_life_main = List.of("minecraft:generic.max_health,14,0") ;

	public static final ForgeConfigSpec.ConfigValue<Boolean> ARMOR_RULE_MODIFY;
	/*
	 * dmg : 1:7
	 * hp  : 2:9
	*/
