...
public class ModelAnemoSlime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("er", "model_anemo_slime"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgb) {
		...
		Lwing.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
		Rwing.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
	}
