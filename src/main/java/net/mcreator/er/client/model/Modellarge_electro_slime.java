...
public class Modellarge_electro_slime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("er", "modellarge_electro_slime"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgb) {
		...
		antenna.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
	}
}