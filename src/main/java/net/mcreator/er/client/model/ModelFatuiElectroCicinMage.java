...
public class ModelFatuiElectroCicinMage<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("er", "model_fatui_electro_cicin_mage"), "main");
