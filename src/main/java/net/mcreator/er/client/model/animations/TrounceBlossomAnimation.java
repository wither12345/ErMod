...
public class TrounceBlossomAnimation {
	public static final AnimationDefinition claim = AnimationDefinition.Builder.withLength(1.0F)
			...
			.addAnimation("Petal8", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 62.5F, 0.0F), AnimationChannel.Interpolations.LINEAR)))
			.build();
}