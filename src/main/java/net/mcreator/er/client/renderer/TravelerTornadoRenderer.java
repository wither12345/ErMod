...
public class TravelerTornadoRenderer extends MobRenderer<TravelerTornadoEntity, ModelTornado<TravelerTornadoEntity>> {
	public TravelerTornadoRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<TravelerTornadoEntity, ModelTornado<TravelerTornadoEntity>>(this) {
            final ResourceLocation ANEMO = new ResourceLocation("er:textures/entities/tornado.png");
            final ResourceLocation ELECTRO = new ResourceLocation("er:textures/entities/electro_tornado.png");
            final ResourceLocation HYDRO = new ResourceLocation("er:textures/entities/hydro_tornado.png");
            final ResourceLocation PYRO = new ResourceLocation("er:textures/entities/pyro_tornado.png");
            final ResourceLocation CRYO = new ResourceLocation("er:textures/entities/cryo_tornado.png");
	...
	public ResourceLocation getTextureLocation(TravelerTornadoEntity entity) {
        return new ResourceLocation("er:textures/entities/null.png");
	}
}