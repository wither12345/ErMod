...
public class StatueofTheSevenCoreRenderer implements BlockEntityRenderer<StatueofTheSevenCoreBlockEntity>{
    ...
    public StatueofTheSevenCoreRenderer(BlockEntityRendererProvider.Context p_173529_) {
    }
    ...
    public void render(StatueofTheSevenCoreBlockEntity blockentity, float p_112141_, PoseStack p_112142_, MultiBufferSource p_112143_, int p_112144_, int p_112145_) {
        ...
        List<BeaconBlockEntity.BeaconBeamSection> list = Lists.newArrayList();
        int j = 0;

        if (blockentity.getPersistentData().getBoolean("active"))
            renderBeaconBeam(p_112142_, p_112143_, p_112141_, i, j, 1024, DyeColor.LIGHT_BLUE.getTextureDiffuseColors());
        else
            renderBeaconBeam(p_112142_, p_112143_, p_112141_, i, j, 1024, DyeColor.RED.getTextureDiffuseColors());
    ...
    public static void renderBeaconBeam(PoseStack p_112185_, MultiBufferSource p_112186_, ResourceLocation p_112187_, float p_112188_, float p_112189_, long p_112190_, int p_112191_, int p_112192_, float[] p_112193_, float p_112194_, float p_112195_) {
        ...
        p_112185_.pushPose();
        p_112185_.translate((double)0.5F, (double)0.0F, (double)0.5F);
    ...
    public boolean shouldRenderOffScreen(StatueofTheSevenCoreBlockEntity p_112138_) {
        return true;
    }
    ...
    public boolean shouldRender(StatueofTheSevenCoreBlockEntity p_173531_, Vec3 p_173532_) {
        return Vec3.atCenterOf(p_173531_.getBlockPos()).multiply((double)1.0F, (double)0.0F, (double)1.0F).closerThan(p_173532_.multiply((double)1.0F, (double)0.0F, (double)1.0F), (double)this.getViewDistance());
    }
}
