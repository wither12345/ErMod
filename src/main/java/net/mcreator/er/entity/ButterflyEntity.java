...
public class ButterflyEntity extends PathfinderMob {
	public ButterflyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ErModEntities.BUTTERFLY.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ErModItems.BUTTERFLY_WINGS.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(ErModEntities.BUTTERFLY.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
