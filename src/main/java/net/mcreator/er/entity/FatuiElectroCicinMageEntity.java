...
public class FatuiElectroCicinMageEntity extends CicinMage {
	public FatuiElectroCicinMageEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ErModEntities.FATUI_ELECTRO_CICIN_MAGE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ErModEntities.FATUI_ELECTRO_CICIN_MAGE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	static class HurtlingBoltsGoal extends Goal {
		...
		public boolean canUse() {
			...
			return mage.getTarget() != null && mage.globalCd <= 0 && !mage.summonings.isEmpty();
		}
