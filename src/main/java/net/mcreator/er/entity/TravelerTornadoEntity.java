...
public class TravelerTornadoEntity extends Monster implements OwnableEntity {
	...
	public TravelerTornadoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ErModEntities.TRAVELER_TORNADO.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(DATA_Absorption, 0);
	}
