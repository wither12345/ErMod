...
public class BlossomOfWealthEntity extends Blossom {
	...
	public BlossomOfWealthEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ErModEntities.BLOSSOM_OF_WEALTH.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ErModEntities.BLOSSOM_OF_WEALTH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
