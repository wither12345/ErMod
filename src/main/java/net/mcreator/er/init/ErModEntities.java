...
public class ErModEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<LinkMechanismTelpher>> LINK_MECHANISM_TELPHER = register("link_mechanism_telpher",
	...
	public static final DeferredHolder<EntityType<?>, EntityType<HealOrbEntity>> HEAL_ORB = register("heal_orb",
