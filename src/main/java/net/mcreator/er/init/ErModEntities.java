...
public class ErModEntities {
	...
	public static final RegistryObject<EntityType<BloomEntity>> BLOOM_ENTITY = register("dendro_core",
	...
	public static final RegistryObject<EntityType<PyroWhopperflower>> PYRO_WHOPPERFLOWER = register("pyro_whopperflower",
	...
	public static final RegistryObject<EntityType<PyroWhopperflowerBall>> PYRO_FLOWER_BALL = register("pyro_flower_ball",
	...
	public static final RegistryObject<EntityType<PyroHomingOrb>> PYRO_HOMING_ROB = register("pyro_homing_rob",
	...
	public static final RegistryObject<EntityType<CryoSpike>> CRYO_SPIKE = register("cryo_spike",
			EntityType.Builder.<CryoSpike>of(CryoSpike::new, MobCategory.MISC).setShouldReceiveVelocityUpdates(true).setTrackingRange(32).setUpdateInterval(3).sized(0.3f, 0.3f));
	public static final RegistryObject<EntityType<CryoWhopperflower>> CRYO_WHOPPERFLOWER = register("cryo_whopperflower",
	...
	public static final RegistryObject<EntityType<HealOrbEntity>> HEAL_ORB = register("heal_orb",
	...
	public static final RegistryObject<EntityType<SpeedOrbEntity>> SPEED_ORB = register("speed_orb",
	...
	public static final RegistryObject<EntityType<EnergyBuffOrbEntity>> ENERGY_BUFF_ORB = register("energy_buff_orb",
	...
	public static final RegistryObject<EntityType<ElectroHypostasisCube>> ELECTRO_HYPOSTASIS_CUBE = register("electro_hypostasis_cube",
	...
	public static final RegistryObject<EntityType<ElectroCubeProjectile>> ELECTRO_CUBE_PROJECTILE = register("electro_cube_projectile",
	...
	public static final RegistryObject<EntityType<ElectroCubeCrystal>> ELECTRO_CUBE_CRYSTAL = register("electro_cube_crystal",
