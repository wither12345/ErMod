...
public class ErModItems {
	...
	public static final RegistryObject<Item> GEO_VISION = REGISTRY.register("geo_vision", () -> new Vision(Element.Category.GEO));
	...
	public static final ElementalArmorItem.Group ANEMO_ARMOR = ElementalArmorItem.Group.createBasic(REGISTRY, ErArmorMaterials.ANEMO, Element.Category.ANEMO);
	public static final ElementalArmorItem.Group HYDRO_ARMOR = ElementalArmorItem.Group.createBasic(REGISTRY, ErArmorMaterials.HYDRO, Element.Category.HYDRO);
	public static final ElementalArmorItem.Group CRYO_ARMOR = ElementalArmorItem.Group.createBasic(REGISTRY, ErArmorMaterials.CRYO, Element.Category.CRYO);
	public static final ElementalArmorItem.Group ELECTRO_ARMOR = ElementalArmorItem.Group.createBasic(REGISTRY, ErArmorMaterials.ELECTRO, Element.Category.ELECTRO);
	public static final ElementalArmorItem.Group PYRO_ARMOR = ElementalArmorItem.Group.createBasic(REGISTRY, ErArmorMaterials.PYRO, Element.Category.PYRO);
	...
	public static final RegistryObject<Item> GAMBLERS_BROOCH = REGISTRY.register("gamblers_brooch", () -> new Artifact(ArtifactSlot.FLOWER_OF_LIFE, ArtifactEffectRegistry.GAMBLER));
	public static final RegistryObject<Item> GAMBLERS_FEATHER_ACCESSORY = REGISTRY.register("gamblers_feather_accessory", () -> new Artifact(ArtifactSlot.PLUME_OF_DEATH, ArtifactEffectRegistry.GAMBLER));
	...
	public static final RegistryObject<Item> INSTRUCTORS_BROOCH = REGISTRY.register("instructors_brooch", () -> new Artifact(ArtifactSlot.FLOWER_OF_LIFE, ArtifactEffectRegistry.INSTRUCTOR));
	public static final RegistryObject<Item> INSTRUCTORS_FEATHER_ACCESSORY = REGISTRY.register("instructors_feather_accessory", () -> new Artifact(ArtifactSlot.PLUME_OF_DEATH, ArtifactEffectRegistry.INSTRUCTOR));
	public static final RegistryObject<Item> INSTRUCTORS_POCKET_WATCH = REGISTRY.register("instructors_pocket_watch", () -> new Artifact(ArtifactSlot.SAND_OF_EON, ArtifactEffectRegistry.INSTRUCTOR));
	public static final RegistryObject<Item> INSTRUCTORS_TEA_CUP = REGISTRY.register("instructors_tea_cup", () -> new Artifact(ArtifactSlot.GOBLET_OF_EONOTHEM, ArtifactEffectRegistry.INSTRUCTOR));
	...
	public static final RegistryObject<Item> TINY_MIRACLES_FLOWER = REGISTRY.register("tiny_miracles_flower", () -> new Artifact(ArtifactSlot.FLOWER_OF_LIFE, ArtifactEffectRegistry.TINY_MIRACLE));
	public static final RegistryObject<Item> TINY_MIRACLES_FEATHER = REGISTRY.register("tiny_miracles_feather", () -> new Artifact(ArtifactSlot.PLUME_OF_DEATH, ArtifactEffectRegistry.TINY_MIRACLE));
	public static final RegistryObject<Item> TINY_MIRACLES_HOURGLASS = REGISTRY.register("tiny_miracles_hourglass", () -> new Artifact(ArtifactSlot.SAND_OF_EON, ArtifactEffectRegistry.TINY_MIRACLE));
	public static final RegistryObject<Item> TINY_MIRACLES_GOBLET = REGISTRY.register("tiny_miracles_goblet", () -> new Artifact(ArtifactSlot.GOBLET_OF_EONOTHEM, ArtifactEffectRegistry.TINY_MIRACLE));
	public static final RegistryObject<Item> TINY_MIRACLES_EARRINGS = REGISTRY.register("tiny_miracles_earrings", () -> new Artifact(ArtifactSlot.CIRCLET_OF_LOGOS, ArtifactEffectRegistry.TINY_MIRACLE));
	public static final RegistryObject<Item> LIGHTNING_PRISM = REGISTRY.register("lightning_prism", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> LIGHTNING_PRISM_UPGRADE = REGISTRY.register("lightning_prism_upgrade", () -> new Item(new Item.Properties()));
	...
	public static class BowItemsClientSideHandler {
		...
		private static void registerVision(Item vision) {
			ItemProperties.register(vision, new ResourceLocation(ErMod.MODID, "vision_frame"), (itemStackToRender, clientWorld, entity, itemEntityId) -> itemStackToRender.getOrCreateTag().getInt("frame"));
		}
