...
public abstract class BakedGlyphMixin implements ShadeGlyph {
    ...
    @Shadow
    public abstract RenderType renderType(Font.DisplayMode p_181388_);
    ...
    public void er$render(int index, int total, boolean p_95227_, float x, float y, Matrix4f matrix4f, VertexConsumer p_95231_, float r, float g, float b, float a, int l) {
        ...
        // 5. 使用新的纹理坐标和顶点位置绘制
        p_95231_.vertex(matrix4f, f + f4, f2, 0.0F)
                .color(r, g, b, a)
                .uv(this.u0, currentV0)   // 左下角
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(l)
                .endVertex();
        p_95231_.vertex(matrix4f, f + f5, f3, 0.0F)
                .color(r, g, b, a)
                .uv(this.u0, currentV1)   // 左上角
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(l)
                .endVertex();
        p_95231_.vertex(matrix4f, f1 + f5, f3, 0.0F)
                .color(r, g, b, a)
                .uv(this.u1, currentV1)   // 右上角
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(l)
                .endVertex();
        p_95231_.vertex(matrix4f, f1 + f4, f2, 0.0F)
                .color(r, g, b, a)
                .uv(this.u1, currentV0)   // 右下角
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(l)
                .endVertex();
    }
