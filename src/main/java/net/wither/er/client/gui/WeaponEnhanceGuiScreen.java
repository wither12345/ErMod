...
public class WeaponEnhanceGuiScreen extends AbstractContainerScreen<WeaponEnhanceGuiMenu> {
    ...
    private static final ResourceLocation texture = ResourceLocation.parse("er:textures/screens/weapon_enhance_gui.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
        ...
        guiGraphics.blit(ResourceLocation.parse("er:textures/screens/weapon_gui_arrow.png"), this.leftPos + 51, this.topPos + 34, 0, 0, 72, 18, 72, 18);
