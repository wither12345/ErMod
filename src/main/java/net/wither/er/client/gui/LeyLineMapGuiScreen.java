...
public class LeyLineMapGuiScreen extends AbstractContainerScreen<LeyLineMapGuiMenu> {
	...
	private static final ResourceLocation statue = ResourceLocation.parse("er:textures/screens/map_statue_of_the_seven.png");
	private static final ResourceLocation waypoint = ResourceLocation.parse("er:textures/screens/map_teleport_waypoint.png");
	private static final ResourceLocation statueHold = ResourceLocation.parse("er:textures/screens/map_statue_of_the_seven_hold.png");
	private static final ResourceLocation waypointHold = ResourceLocation.parse("er:textures/screens/map_teleport_waypoint_hold.png");
