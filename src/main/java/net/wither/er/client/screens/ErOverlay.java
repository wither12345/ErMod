...
public class ErOverlay {
	...
	private static final ResourceLocation skillL = ResourceLocation.parse("er:textures/screens/elemental_skill_l.png");
	private static final ResourceLocation skillR = ResourceLocation.parse("er:textures/screens/elemental_skill_r.png");
	private static final ResourceLocation energy = ResourceLocation.parse("er:textures/screens/energy_filling.png");
	private static final ResourceLocation burstL = ResourceLocation.parse("er:textures/screens/elemental_burst_l.png");
	private static final ResourceLocation burstR = ResourceLocation.parse("er:textures/screens/elemental_burst_r.png");
	private static final ResourceLocation HEALTH_BAR_BASE = ResourceLocation.parse("er:hud/health/player_health_bar_base");
	private static final ResourceLocation HEALTH_BAR_FILLING = ResourceLocation.parse("er:hud/health/player_health_bar_filling");
	private static final ResourceLocation HEALTH_BAR_BLINKING = ResourceLocation.parse("er:hud/health/player_health_bar_blinking");
	private static final ResourceLocation HEALTH_BAR_ABSORBING = ResourceLocation.parse("er:hud/health/player_health_bar_absorbing");
	...
	public static void onRenderGuiOverlay(RenderGuiLayerEvent.Pre event) {
		Player player = Minecraft.getInstance().player;
		if(event.getName() == VanillaGuiLayers.PLAYER_HEALTH && ERClientConfig.PLAYER_HEALTH.get() == ERClientConfig.HealthBarEnum.Bar) {
			event.setCanceled(true);
			renderPlayerHealthBar(player,event.getGuiGraphics());
		} else if (event.getName() == VanillaGuiLayers.ARMOR_LEVEL && ERClientConfig.PLAYER_HEALTH.get() == ERClientConfig.HealthBarEnum.Bar) {
			event.setCanceled(true);
