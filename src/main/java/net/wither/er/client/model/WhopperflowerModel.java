package net.wither.er.client.model;
...
public class WhopperflowerModel<T extends Whopperflower> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("er", "model_whopperflower"), "main");
