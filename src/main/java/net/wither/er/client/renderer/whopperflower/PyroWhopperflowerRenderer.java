...
public class PyroWhopperflowerRenderer extends WhopperflowerRenderer<Whopperflower> {
    ResourceLocation LOCATION = ResourceLocation.fromNamespaceAndPath(ErMod.MODID, "textures/entities/pyro_whopperflower.png");
    ResourceLocation SHIELD_LOCATION = ResourceLocation.fromNamespaceAndPath(ErMod.MODID, "textures/entities/pyro_whopperflower_shield.png");
