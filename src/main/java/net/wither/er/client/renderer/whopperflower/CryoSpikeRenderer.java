...
public class CryoSpikeRenderer extends EntityRenderer<CryoSpike> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ErMod.MODID, "cryo_spike"), "main");
    private static final ResourceLocation LOCATION = new ResourceLocation(ErMod.MODID, "textures/entities/cryo_spike.png");
