...
public abstract class AbstractHypostasisCubeRenderer<T extends HypostasisCube> extends EntityRenderer<T> {
    ...
    public void render(@NotNull T cube, float f, float dt, @NotNull PoseStack poseStack, @NotNull MultiBufferSource source, int l) {
        ...
        vertexConsumer = source.getBuffer(renderType);

        RenderVertex.vertex(vertexConsumer, pose, i, 0.0F, 0, 0, 0.5f);
        RenderVertex.vertex(vertexConsumer, pose, i, 1F, 0, 0.25f, 0.5f);
        RenderVertex.vertex(vertexConsumer, pose, i, 1F, 1, 0.25f, 0);
        RenderVertex.vertex(vertexConsumer, pose, i, 0.0F, 1, 0, 0);
