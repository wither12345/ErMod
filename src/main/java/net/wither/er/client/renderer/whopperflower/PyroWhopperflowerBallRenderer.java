...
public class PyroWhopperflowerBallRenderer extends EntityRenderer<PyroWhopperflowerBall> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ErMod.MODID, "pyro_flower_ball"), "main");
    private static final ResourceLocation LOCATION = ResourceLocation.fromNamespaceAndPath(ErMod.MODID, "textures/entities/pyro_flower_ball.png");
