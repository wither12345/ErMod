...
public class HealOrbRenderer extends EntityRenderer<HealOrbEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.parse("er:textures/entities/heal_orb.png");
    ...
    protected int getBlockLightLevel(@NotNull HealOrbEntity projectile, @NotNull BlockPos pos) {
        return 15;
    }

    public void render(@NotNull HealOrbEntity projectile, float v, float v1, PoseStack poseStack, MultiBufferSource source, int i) {
        poseStack.pushPose();
