...
public class LunarCrystallizeRenderer extends EntityRenderer<LunarCrystallize> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ErMod.MODID, "lunar_crystallize"), "main");
    private static final ResourceLocation LOCATION = new ResourceLocation(ErMod.MODID, "textures/entities/lunar_crystallize.png");
