...
public class CryoWhopperflowerRenderer extends WhopperflowerRenderer<Whopperflower> {
    ResourceLocation LOCATION = ResourceLocation.fromNamespaceAndPath(ErMod.MODID, "textures/entities/cryo_whopperflower.png");
    ResourceLocation SHIELD_LOCATION = ResourceLocation.fromNamespaceAndPath(ErMod.MODID, "textures/entities/cryo_whopperflower_shield.png");
