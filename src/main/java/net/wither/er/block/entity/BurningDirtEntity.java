...
public class BurningDirtEntity extends BlockEntity implements TraceableEntity {
    private static final TagKey<Block> BURNABLE_TAG = TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(ErMod.MODID, "burnable"));
    private static final TagKey<EntityType<?>> BURNING_BYPASSES = TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(ErMod.MODID, "bypasses_block_burning"));
    ...
    public void burn(@NotNull Entity entity) {
        if(this.level instanceof ServerLevel serverLevel &&
            ...
            entity.hurt(new DamageSource(serverLevel.holderOrThrow(Element.BURNING), owner), EntityHurtEvent.getLevelMultiply(getOwner()));
        }
    }
