...
public class RegisterDatas {
	...
	public static void Register(final RegisterPayloadHandlersEvent event) {
		...
		registrar.commonToServer(LeyLineLeapData.TYPE, LeyLineLeapData.STREAM_CODEC, new DirectionalPayloadHandler<>(LeyLineLeapData::handle, LeyLineLeapData::handle));
	    ...
	    registrar.commonToServer(LineMechanismMessage.TYPE, LineMechanismMessage.STREAM_CODEC, LineMechanismMessage::handle);
    }
}
