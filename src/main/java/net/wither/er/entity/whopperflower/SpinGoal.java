...
public class SpinGoal extends Goal {
    ...
    public boolean canUse() {
        if(this.whopperflower.cd > 0 || this.whopperflower.spinCd > 0 || this.whopperflower.getAction() != Whopperflower.Action.NORMAL) return false;
                    ...
                    .stream().filter(e -> EntityHurtEvent.shouldHurt(e, this.whopperflower)).forEach(
                            e -> e.hurt(
                                    ElementSource.createDamageSource(
                                            ...
                                            this.whopperflower,
                                            new ElementSource(element, ResourceLocation.parse("er:whopperflower.spin") , 2, true)
