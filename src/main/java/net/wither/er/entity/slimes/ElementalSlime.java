            ...
            if(this.timer > 0)
                ...
                if(this.slime.hasElement())
                    this.target.hurt(
                            ...
                            this.slime,
                            new ElementSource(this.slime.getElement(), ResourceLocation.parse("er:mob_attack"), 1, true)), (float) this.slime.getAttributeValue(Attributes.ATTACK_DAMAGE)
                    );
                else
                    this.target.hurt(new DamageSource(this.slime.level().holderOrThrow(DamageTypes.MOB_ATTACK), this.slime), (float) this.slime.getAttributeValue(Attributes.ATTACK_DAMAGE));
