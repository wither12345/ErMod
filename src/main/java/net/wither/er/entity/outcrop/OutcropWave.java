                ...
                if(modifierElement != null) {
                    if(modifierElement.isJsonArray()){
                        for(JsonElement ele : modifierElement.getAsJsonArray()){
                            ...
                            EntityModifier.Builder builder = AdditionalRegistries.ENTITY_MODIFIER_REGISTRY.get(ResourceLocation.parse(modifier_type));
                            if(builder == null)
                                continue;;
                        ...
                        for (String key : keys) {
                            EntityModifier.Builder builder = AdditionalRegistries.ENTITY_MODIFIER_REGISTRY.get(ResourceLocation.parse(key));
                            if (builder == null) {
                                continue;
                            }
