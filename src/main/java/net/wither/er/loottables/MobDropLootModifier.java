...
public class MobDropLootModifier extends LootModifier implements IGlobalLootModifier{
    ...
    private static final TagKey<Item> tier2 = ItemTags.create(new ResourceLocation("er:tier2"));
    private static final TagKey<Item> tier3 = ItemTags.create(new ResourceLocation("er:tier3"));
