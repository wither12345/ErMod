...
public class Burning extends Element{
    ...
    public static void burn(LevelAccessor accessor, double x, double y, double z, @Nullable Entity applier){
        ...
        if(applier instanceof LivingEntity living && living.getAttribute(ErModAttributes.ELEMENTAL_MASTERY.get()) != null){
            elemental_mastery = living.getAttribute(ErModAttributes.ELEMENTAL_MASTERY.get()).getValue();
        }
        ...
        for (LivingEntity entityiterator : _entfound) {
            if(applier == null) {
                if(entityiterator.getAttribute(ErModAttributes.ELEMENTAL_MASTERY.get()) != null)
                        elemental_mastery = entityiterator.getAttribute(ErModAttributes.ELEMENTAL_MASTERY.get()).getValue();
