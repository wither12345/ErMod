...
public class Anemo extends Element{
    public static final TagKey<EntityType<?>> immune = TagKey.create(ENTITY_TYPE, new ResourceLocation("er:anemo_immune"));
            ...
            if (EntityHurtEvent.shouldHurt(applier, entityiterator))
                entityiterator.hurt(
                        ElementSource.createDamageSource(
                                ...
                                applier ,
                                new ElementSource(element, new ResourceLocation("er:anemo.reaction"), gauge, true)
