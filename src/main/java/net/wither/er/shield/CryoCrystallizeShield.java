...
public class CryoCrystallizeShield extends ErShield implements RenderShield {
	private static final UUID uuid = UUID.fromString("19A52058-8C03-754F-F1E2-8B16F6CA9608");

	@OnlyIn(Dist.CLIENT)
	public static class Client {
		private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("er:textures/entities/cryo_crystallize_shield.png");
