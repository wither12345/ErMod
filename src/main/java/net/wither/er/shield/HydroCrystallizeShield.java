...
public class HydroCrystallizeShield extends ErShield implements HeartChangingShield, RenderShield {
	private static final ResourceLocation resourcelocation = ResourceLocation.parse("er:hydro_crystallize.kb_res");

	@OnlyIn(Dist.CLIENT)
	public static class Client {
		private static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.parse("er:textures/entities/hydro_crystallize_shield.png");
