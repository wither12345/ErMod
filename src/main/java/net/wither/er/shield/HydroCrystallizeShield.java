...
public class HydroCrystallizeShield extends ErShield implements RenderShield {
	private static final UUID uuid = UUID.fromString("2EF5C2F0-742A-CD8B-5C08-FAB5C8E7767E");

	@OnlyIn(Dist.CLIENT)
	public static class Client {
        private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("er:textures/entities/hydro_crystallize_shield.png");
