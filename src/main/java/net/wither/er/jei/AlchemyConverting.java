...
public class AlchemyConverting implements IRecipeCategory<AlchemyConvertingRecipe> {
    public final static ResourceLocation UID = ResourceLocation.parse("er:alchemy_converting");
    public final static ResourceLocation TEXTURE = ResourceLocation.parse("er:textures/screens/alchemy_converting_jei.png");
