...
public class ModelFlaming_Flower<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "flaming_flower"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leaves = partdefinition.addOrReplaceChild("leaves",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -1.0F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(40, 6)
						.addBox(-2.0F, -2.0F, -3.0F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(46, 0)
						.addBox(-1.0F, -4.0F, -2.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition roots = partdefinition.addOrReplaceChild("roots", CubeListBuilder.create().texOffs(0, 0).addBox(
				0.0F, -9.0F, -1.0F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition flowers = partdefinition.addOrReplaceChild("flowers",
				CubeListBuilder.create().texOffs(30, 0)
						.addBox(-1.5F, -10.0F, -2.5F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(30, 5)
						.addBox(-1.0F, -12.0F, -2.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
