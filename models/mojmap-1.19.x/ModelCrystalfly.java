...
public class ModelCrystalfly<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "crystalfly"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(
				0.0F, -0.5F, -3.0F, 1.0F, 0.5F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition left_wing = partdefinition.addOrReplaceChild("left_wing",
				CubeListBuilder.create().texOffs(3, 0)
						.addBox(-4.0F, 0.0F, -5.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(-2, 0)
						.addBox(-1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(-1, 0)
						.addBox(-2.0F, 0.0F, 1.0F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_wing = partdefinition.addOrReplaceChild("right_wing",
				CubeListBuilder.create().texOffs(11, 0)
						.addBox(1.0F, 0.0F, -5.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(-2, 0)
						.addBox(1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(-1, 0)
						.addBox(2.0F, 0.0F, 1.0F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 1.0F));
